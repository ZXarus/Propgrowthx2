              ...
              <div className="space-y-2 md:space-y-4">
                <div className="relative w-full h-24 md:h-32 rounded-xl overflow-hidden bg-gray-200">
                  ...
                  <div className="absolute top-1 md:top-3 right-1 md:right-3">
                    <span
                      className={`px-2 py-0.5 md:px-3 md:py-1 rounded-full text-xs font-semibold border ${statusColors[property.status]}`}
                    >
                      {property.status}
                    </span>
                  </div>
                ...
                <div className="space-y-1 md:space-y-3">
                  ...
                  <div className="flex items-center justify-between pt-1 md:pt-2">
                    <div className="text-lg md:text-3xl font-bold text-gray-900">
                      ...
                      <span className="text-xs md:text-base font-normal text-gray-500 ml-1">
                        /month
                      </span>
                    </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 md:gap-6">
              ...
              <div className="text-gray-600 text-sm md:text-base">
                ...
                <span className="font-semibold text-gray-900">
                  ₹
                  {properties
                    .reduce((sum, p) => sum + p.monthly_rent, 0)
                    .toLocaleString()}
                </span>
                /month
              </div>
