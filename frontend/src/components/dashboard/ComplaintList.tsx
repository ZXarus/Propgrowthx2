...
export default function ComplaintList({
  ...
  const handleStatusChange = async (
    ...
    const updated = complaints.map((c) => (c.id === data.id ? data : c));
                        ...
                        <div className="meta-row">
                          {isOwner && (
                            <span className="flex items-center gap-1">
                              ...
                              {complaints.tenant_name || "User"}
                            </span>
                          )}
                          <span className="flex items-center gap-1">
                            <Home className="w-4 h-4" />
                            {complaints?.property_name || "Unknown"}
                          </span>
                        </div>
                    ...
                    <div className="complaint-right">
                      ...
                      {complaint.responses.length > 0 && (
                        <div className="flex items-center gap-1 text-secondary">
                          ...
                          {complaint.responses.length} conversation
            ...
            {selectedComplaint && (
              <>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Submitted by {complaints.tenant_name || "User"}- on{" "}
                  ...
                  {isOwner && (
                    <div className="p-4 bg-accent rounded-lg">
                      ...
                      <div className="mt-2 flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-medium">
                            {complaints.tenant_name || "Unknown"}
                          </p>
                        </div>
                      </div>
                    </div>
