...
const propertyManagementImage =
  "https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&h=500&fit=crop";
const tenantCommunicationImage =
  "https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&h=500&fit=crop";
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "PropGrowthX: The digital twin platform for property owners. Manage rentals, tenants, maintenance, and finances remotely with real-time visibility and control.",
      );
    } else {
    ...
    if (metaKeywords) {
      metaKeywords.setAttribute(
        "content",
        "property management, rental management, tenant management, property digital twin, remote property management, real estate SaaS, landlord software, rent collection",
      );
    } else {
      const meta = document.createElement("meta");
      meta.name = "keywords";
      ...
      <div className="min-h-screen bg-white overflow-hidden">
        ...
        <div className="relative bg-white overflow-hidden border-b border-gray-200">
          ...
          <div className="absolute inset-0 opacity-5">
            ...
            <div
              className="absolute top-1/2 right-1/4 w-64 h-64 bg-black rounded-full mix-blend-multiply filter blur-xl animate-pulse"
            ...
            >
              ...
              <p className="mt-8 max-w-4xl mx-auto text-xl sm:text-2xl text-gray-700 leading-relaxed font-light">
                ...
                <span className="font-semibold text-black">
                  remote property management platform
                </span>{" "}
                that creates a{" "}
                <span className="font-semibold text-black">
                  digital twin of every property
                </span>
                . We empower property owners, brokers, and managers with{" "}
                <span className="font-semibold text-black">
                  real-time visibility, automated workflows, and data-driven
                  insights
                </span>{" "}
                to manage properties efficiently without physical visits.
              </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          {/* The Problem Section */}
          <div
            className={`text-center mb-20 lg:mb-28 transform transition-all duration-1000 delay-300 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
          >
            ...
            <p className="text-lg sm:text-xl text-gray-700 max-w-3xl mx-auto mb-12">
              Property owners today rely on outdated methods that create chaos,
              uncertainty, and lost control.
            </p>
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-gray-700 max-w-3xl mx-auto mb-16">
              Every property gets a digital presence that gives owners complete
              control and visibility—without ever visiting the property.
            </p>
          ...
          {/* Core Features Grid */}
          <div
            className={`mt-20 lg:mt-28 transform transition-all duration-1000 delay-600 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
          >
          ...
          <div
            className={`mt-20 lg:mt-28 transform transition-all duration-700 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
          >
              ...
              <div className="max-w-3xl mx-auto relative z-10">
                <p className="text-base text-gray-100 leading-relaxed">
                  ...
                  <span className="font-semibold text-red-400">
                    operating system for property owners
                  </span>{" "}
                  worldwide. We envision a future where{" "}
                  <span className="font-semibold text-white">
                    property management is digital, transparent, and automated
                  </span>
                  —where owners feel{" "}
                  <span className="font-semibold text-red-400">
                    directly connected to their assets
                  </span>{" "}
                  regardless of location. By replacing{" "}
                  <span className="font-semibold text-white">
                    Excel, WhatsApp, and uncertainty with real-time control
                  </span>
                  , PropGrowthX empowers property owners to build wealth with
                  confidence.
                </p>
              </div>
          ...
          {/* Philosophy Section */}
          <div
            className={`mt-20 lg:mt-28 transform transition-all duration-1000 delay-700 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
          >
          ...
          <div
            className={`mt-24 lg:mt-32 transform transition-all duration-1000 delay-1000 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
          >
            <div className="text-center mb-12">
              <div className="inline-block mb-3">
                <div className="w-12 h-1 bg-red-600 mx-auto mb-2"></div>
          ...
          {/* Call to Action */}
          <div
            className={`mt-20 lg:mt-28 transform transition-all duration-1000 delay-1000 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
          >
            <div className="text-center">
              ...
              <p className="text-lg text-gray-700 max-w-2xl mx-auto mb-8">
                Join property owners who have replaced chaos with control. Start
                managing your properties with confidence today.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button
                  onClick={handleGetStarted}
                  className="px-8 py-3 bg-red-600 text-white font-semibold rounded-lg hover:bg-red-700 transition-colors duration-300 shadow-lg"
                >
                  Get Started Free
                </button>
              </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex-1">
        <div
          className={`inline-flex items-center justify-center h-14 w-14 rounded-xl bg-gradient-to-br ${bgColor} text-white mb-4 group-hover:scale-110 transition-all duration-300 shadow-lg`}
        >
...
const EnhancedFeatureSection = ({
  ...
  return (
    <div
      className={`flex flex-col ${reversed ? "lg:flex-row-reverse" : "lg:flex-row"} items-center gap-8 lg:gap-12`}
    >
...
const FeatureModule = ({
  ...
  return (
    <div
      className={`group relative bg-white p-6 rounded-2xl shadow-md border border-gray-100 hover:shadow-lg transition-all duration-300 h-full flex flex-col`}
    >
      <div className="flex items-start gap-4 mb-6">
        <div
          className={`inline-flex items-center justify-center h-12 w-12 rounded-xl ${iconBg} text-white flex-shrink-0`}
        >
          <Icon className="h-6 w-6" />
        </div>
...
const PhilosophyCard = ({
  ...
  return (
    <div
      className={`group relative bg-gradient-to-br ${bgGradient} p-6 rounded-2xl border ${borderColor} shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 h-full flex flex-col`}
    >
      <div
        className={`inline-flex items-center justify-center h-11 w-11 rounded-lg ${iconBg} text-white mb-4 group-hover:scale-110 transition-all duration-300`}
      >
