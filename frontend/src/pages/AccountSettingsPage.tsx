  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Manage your account security, billing, and property preferences."
        />
      </Helmet>
          ...
          <div className="bg-white border border-gray-200 rounded-xl shadow-sm">
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              <Button
                asChild
                variant="outline"
                className="justify-start h-auto py-5 px-5 border border-gray-200 rounded-lg hover:border-gray-300 hover:bg-gray-50 transition-colors shadow-sm"
              >
              ...
              <Button
                asChild
                variant="outline"
                className="justify-start h-auto py-5 px-5 border border-gray-200 rounded-lg hover:border-gray-300 hover:bg-gray-50 transition-colors shadow-sm md:col-span-2"
              >
