...
const PropertyDetails = () => {
  ...
  const getTypeBadge = (type: string) => {
    switch (type) {
      case "For Sale":
        return (
          <Badge className="bg-success text-primary-foreground">{type}</Badge>
        );
      case "For Rent":
        return (
              ...
              <div className="space-y-6">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-3">
                    ...
                    >
                      <Heart
                        className={`w-4 h-4 mr-2 ${isFavorite ? "fill-destructive text-destructive" : ""}`}
                      />
                ...
                {isOwner && (
                  <div className="space-y-4">
                    <Card>
                      ...
                      <CardContent className="space-y-3">
                        <Button
                          onClick={() => handleGenerate(id, property.owner_id)}
                          disabled={loading}
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div
                      ...
                      onClick={() =>
                        navigate(`/profile/${property.owner_id}`, {
                          state: { fromProperty: true },
                        })
                      }
                    >
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      <div
                        className="flex items-center gap-3 cursor-pointer"
                        onClick={() =>
                          navigate(`/profile/${property.buyer_id}`, {
                            state: { fromProperty: true },
                          })
                        }
                      >
