...
const OwnerTransactions = () => {
  ...
  // transactions.filter((tx) => tx.owner_id === id),
    ...
    const checkOverduePayments = () => {
      ...
      setPayments((prevPayments) =>
        prevPayments.map((payment) => {
          ...
          let newStatus: "completed" | "pending" | "overdue" | "upcoming" =
            payment.status;
  ...
  const getPaymentStatusBadge = (status: string) => {
    switch (status) {
      case "paid":
        return (
          <Badge className="bg-success text-primary-foreground">Paid</Badge>
        );
      case "pending":
        return <Badge className="bg-warning text-foreground">Pending</Badge>;
      case "overdue":
                            ...
                            return (
                              ...
                              >
                                ...
                                <TableCell className="text-foreground">
                                  {/* {
                                    profile.find((p) => p.id === tx.tenant_id)
                                      ?.name
                                  } */}
                                </TableCell>
