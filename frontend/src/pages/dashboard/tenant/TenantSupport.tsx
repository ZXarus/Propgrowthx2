        ...
        <main className="flex-1 overflow-y-auto min-w-0">
          <div className="min-h-screen bg-white">
            ...
            <section className="relative bg-white pt-12 pb-0 overflow-hidden">
              <div
                className={`sp-container relative z-10 ${!sidebarOpen ? "pl-16 md:pl-8" : ""}`}
              >
                <div className="pb-8">
              ...
              <div className="max-w-6xl mx-auto">
                <div className="grid lg:grid-cols-1 gap-6 md:gap-8">
                  <div className="section-heading mb-2 md:mb-3">
                    <h2 className="text-xl md:text-2xl font-semibold text-gray-900 mb-1 md:mb-2">
                      Get in touch
                    </h2>
                    ...
                    <main className="form-card" aria-label="Contact form">
                      {isSubmitted ? (
                        ...
                        >
                          ...
                          <h3 className="text-lg md:text-xl font-semibold tracking-tight text-gray-900 mb-2">
                            Message received
                          </h3>
