...
const TenantTransactions = () => {
  ...
  // Desktop: controls wide (true) / narrow (false)
        ...
        <main className="flex-1 overflow-y-auto min-w-0">
          <div className="min-h-screen bg-white">
            <style>{`
              ...
              @media (max-width: 640px) { .tx-back-btn { padding: 8px 10px; font-size: 12px; gap: 6px; } }
              .tx-back-btn:hover { transform: translateY(-3px); box-shadow: 0 10px 28px rgba(2,6,23,0.06); }
            ...
            {/* Header — left padding shifts text away from floating button on mobile */}
...
// Icon-only button — mobile collapsed strip only (no longer used, but kept for reference)
const IconOnlyBtn = ({
  icon: Icon,
  label,
  active = false,
...
// Full sidebar item — desktop sidebar + mobile drawer
const SidebarItem = ({
  icon: Icon,
  label,
  active = false,
