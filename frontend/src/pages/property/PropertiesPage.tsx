          ...
          <div className="max-w-6xl mx-auto">
            <div className="prop-header-hero">
              ...
              <p className="prop-header-subtitle">
                Manage your property portfolio, track performance, and monitor
                tenant information all in one place.
              </p>
...
function MobileNavItem({
  ...
  return (
    ...
    >
      ...
      <span
        className={`text-sm font-medium ${active ? "text-red-600 font-semibold" : ""}`}
      >
        {label}
      </span>
    </button>
    ...
    <div className="bg-white rounded-xl border border-gray-100 overflow-hidden hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group flex flex-col h-full">
      <div className="h-40 sm:h-48 lg:h-56 bg-gradient-to-br from-gray-100 to-gray-200 relative overflow-hidden">
        ...
        <div className="absolute top-3 left-3 sm:top-4 sm:left-4">
          <span
            className={`px-3 py-1 rounded-full text-xs font-semibold ${statusColors[property.status as keyof typeof statusColors] || "bg-gray-100 text-gray-800"}`}
          >
            {property.status}
          </span>
        </div>
      ...
      <div className="p-4 sm:p-5 lg:p-6 flex flex-col flex-1">
        ...
        <p className="text-xs sm:text-sm text-gray-600 mb-4 line-clamp-1 flex items-center gap-1">
          <i className="fas fa-map-marker-alt text-xs flex-shrink-0"></i>
        ...
        <div className="flex items-center gap-3 text-xs sm:text-sm text-gray-600 mb-4 flex-wrap">
          <div className="flex items-center gap-1.5">
            <i className="fas fa-bed text-xs text-red-600"></i>
            <span>
              {property.bedrooms} {property.bedrooms === 1 ? "Bed" : "Beds"}
            </span>
          </div>
          <div className="flex items-center gap-1.5">
            <i className="fas fa-bath text-xs text-red-600"></i>
            <span>
          ...
          {property.total_area && (
            <div className="flex items-center gap-1.5">
              <i className="fas fa-ruler-combined text-xs text-red-600"></i>
        ...
        <div className="flex gap-2 mt-auto">
          <button className="flex-1 px-3 py-2.5 sm:py-3 rounded-lg border border-gray-200 text-xs sm:text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all duration-200">
            Edit
          </button>
          <button
            className="flex-1 px-3 py-2.5 sm:py-3 rounded-lg text-white text-xs sm:text-sm font-medium transition-all duration-200 hover:shadow-lg transform hover:-translate-y-0.5"
        ...
        <table className="w-full">
          <thead className="bg-gray-50 border-b border-gray-100">
            <tr>
              ...
              <th className="text-left py-3 sm:py-4 px-4 sm:px-6 text-xs sm:text-sm font-semibold text-gray-900 hidden xs:table-cell">
                Type
              </th>
              <th className="text-left py-3 sm:py-4 px-4 sm:px-6 text-xs sm:text-sm font-semibold text-gray-900">
                Rent
              </th>
              <th className="text-left py-3 sm:py-4 px-4 sm:px-6 text-xs sm:text-sm font-semibold text-gray-900 hidden sm:table-cell">
                Status
              </th>
              <th className="text-left py-3 sm:py-4 px-4 sm:px-6 text-xs sm:text-sm font-semibold text-gray-900 hidden md:table-cell">
                Details
              </th>
              <th className="text-right py-3 sm:py-4 px-4 sm:px-6 text-xs sm:text-sm font-semibold text-gray-900">
                Actions
              </th>
            </tr>
          </thead>
...
function PropertyRow({ property }: { property: PropertyData }) {
  ...
  return (
    <tr className="hover:bg-gray-50 transition-colors duration-200">
      ...
      <td className="py-3 sm:py-4 px-4 sm:px-6 hidden xs:table-cell text-gray-600 text-xs sm:text-sm">
        {property.listing_type}
      </td>
      <td className="py-3 sm:py-4 px-4 sm:px-6">
      ...
      <td className="py-3 sm:py-4 px-4 sm:px-6 hidden sm:table-cell">
        <span
          className={`px-3 py-1 rounded-full text-xs font-semibold whitespace-nowrap inline-block ${statusColors[property.status as keyof typeof statusColors] || "bg-gray-100 text-gray-800"}`}
        >
          {property.status}
        </span>
      </td>
      ...
      <td className="py-3 sm:py-4 px-4 sm:px-6 text-right">
        <div className="flex items-center justify-end gap-2">
          ...
          <button
            className="px-3 py-1.5 sm:py-2 rounded-lg text-white text-xs sm:text-sm font-medium transition-all duration-200"
            style={{ background: BRAND }}
          >
            View
          </button>
