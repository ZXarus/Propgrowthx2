  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Configure property management, listing defaults, and display preferences."
        />
      </Helmet>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="page-subtitle">
                    Configure defaults, display preferences, and property
                    management rules
                  </p>
                </div>
              </div>
                ...
                <div className="settings-card-header">
                  ...
                  <div>
                    <h2 className="text-lg font-semibold text-gray-900">
                      Default Property Form Values
                    </h2>
                    <p className="text-sm text-gray-600 mt-1">
                      Pre-fill values in AddPropertyModal for new listings
                    </p>
                  </div>
                </div>
                <div className="settings-card-content space-y-4">
                  <div className="setting-row">
                    <div>
                      ...
                      <div className="setting-description">
                        Auto-selected in new property form
                      </div>
                    </div>
                    <select
                  ...
                  <div className="setting-row">
                    <div>
                      ...
                      <div className="setting-description">
                        Minimum and maximum rent suggestions
                      </div>
                    </div>
                  ...
                  <div className="setting-row">
                    <div>
                      ...
                      <div className="setting-description">
                        Comma-separated, auto-suggested
                      </div>
                    </div>
                    <input
                      type="text"
                      ...
                      onChange={(e) =>
                        handleChangeSetting("defaultAmenities", e.target.value)
                      }
                      className="input-field"
              ...
              <div className="settings-card">
                <div className="settings-card-header">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      Control how properties appear in PropertiesPage
                    </p>
                  </div>
                </div>
                <div className="settings-card-content space-y-4">
                  <div className="setting-row">
                    <div>
                      ...
                      <div className="setting-description">
                        Grid or List view on page load
                      </div>
                    </div>
                    <select
                  ...
                  <div className="setting-row">
                    <div>
                      ...
                      <div className="setting-description">
                        Display full description in cards
                      </div>
                    </div>
                  ...
                  <div className="setting-row">
                    <div>
                      ...
                      <div className="setting-description">
                        Display amenities in property cards
                      </div>
                    </div>
                    <label className="toggle-switch">
                      <input
              ...
              <div className="settings-card">
                <div className="settings-card-header">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      Configure property creation and management behavior
                    </p>
                  </div>
                </div>
                <div className="settings-card-content space-y-4">
                  ...
                  <div className="setting-row">
                    <div>
                      ...
                      <div className="setting-description">
                        Automatically calculate from dimensions
                      </div>
                    </div>
                    <label className="toggle-switch">
                      <input
              ...
              <div className="settings-card">
                <div className="settings-card-header">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      Organize and manage your property portfolio
                    </p>
                  </div>
                </div>
                <div className="settings-card-content space-y-4">
                  <div className="setting-row">
                    <div>
                      ...
                      <div className="setting-description">
                        Show intelligent search suggestions
                      </div>
                    </div>
                    <label className="toggle-switch">
                      <input
                        ...
                        onChange={(e) =>
                          handleChangeSetting(
                            "enablePropertySearchSuggestions",
                            e.target.checked,
                          )
                        }
                      />
              ...
              <div className="settings-card">
                <div className="settings-card-header">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      Manage rent collection and reminders
                    </p>
                  </div>
                </div>
                <div className="settings-card-content space-y-4">
                  <div className="setting-row">
                    <div>
                      ...
                      <div className="setting-description">
                        Expected rent collection day (1-28)
                      </div>
                    </div>
                    <input
                      type="number"
                  ...
                  {settings.sendRentReminders && (
                    <div className="setting-row">
                      <div>
                        ...
                        <div className="setting-description">
                          Days before rent collection to send reminder
                        </div>
                      </div>
                      <input
                        type="number"
              ...
              <div className="settings-card">
                <div className="settings-card-header">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      Enable extra features and functionality
                    </p>
                  </div>
                </div>
                <div className="settings-card-content space-y-4">
                  ...
                  <div className="setting-row">
                    <div>
                      ...
                      <div className="setting-description">
                        Display property creation date
                      </div>
                    </div>
                    <label className="toggle-switch">
                      <input
              ...
              <div className="info-box warning">
                ...
                <div>
                  <p className="text-sm text-amber-800">
                    <strong>Note:</strong> These settings apply to how your
                    property forms are pre-filled and how properties are
                    displayed across the application. Changes take effect
                    immediately on new properties and views.
                  </p>
                </div>
              </div>
            </div>
