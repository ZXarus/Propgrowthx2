  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Manage your billing, payments, and invoices."
        />
      </Helmet>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="page-subtitle">
                    Manage your accounts, invoices, and payment methods
                  </p>
                </div>
              </div>
            </div>
                    ...
                    <div className="bg-white border border-gray-100 rounded-16 p-6">
                      ...
                      <div className="space-y-3">
                        {invoices.slice(0, 5).map((invoice) => (
                          <div
                            key={invoice.id}
                            className="invoice-item flex items-center justify-between"
                          >
                            <div className="flex-1">
                            ...
                            <div className="flex items-center gap-4">
                              <div className="text-right">
                                ...
                                <span
                                  className={`inline-flex items-center gap-1 px-3 py-1 text-xs font-semibold rounded-full mt-2 ${getStatusColor(invoice.status)}`}
                                >
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center justify-between p-4 border border-gray-200 rounded-12">
                          <div>
                            ...
                            <div className="text-sm text-gray-600 mt-1">
                              Your subscription will renew automatically each
                              month
                            </div>
                          </div>
                          <input
                        ...
                        <div className="flex items-center justify-between p-4 border border-gray-200 rounded-12">
                          <div>
                            ...
                            <div className="text-sm text-gray-600 mt-1">
                              Receive invoice copies via email
                            </div>
                          </div>
                          <input
                            type="checkbox"
              ...
              <div className="space-y-6">
                <div className="summary-card">
                  ...
                  <div className="summary-section">
                    ...
                    <div className="summary-item">
                      ...
                      <span className="summary-item-value text-red-600">
                        15 Apr 2024
                      </span>
                    </div>
                    <div className="summary-item">
                ...
                <div className="bg-blue-50 border border-blue-100 rounded-14 p-6">
                  ...
                  <p className="text-sm text-blue-700 mb-4">
                    Check our billing FAQ or contact support for assistance with
                    your account.
                  </p>
                  <Button
                    variant="outline"
                  ...
                  <div className="mb-6 pb-6 border-b border-gray-100">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center text-sm">
                        ...
                        <span
                          className={`inline-flex items-center gap-1 px-3 py-1 text-xs font-semibold rounded-full ${getStatusColor(selectedInvoice.status)}`}
                        >
