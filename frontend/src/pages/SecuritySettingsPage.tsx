...
const SecuritySettingsPage = () => {
  ...
  const handleLogoutAllSessions = () => {
    setActiveSessions([
      activeSessions.find((s) => s.isCurrent) || activeSessions[0],
    ]);
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Manage your security settings and account protection."
        />
      </Helmet>
                ...
                <div className="settings-card-content space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="text-xs text-gray-500 mt-2">
                      At least 8 characters, mix of uppercase, lowercase, and
                      numbers
                    </div>
                  </div>
                  ...
                  {twoFactorEnabled && (
                    <div className="space-y-3 p-4 bg-amber-50 rounded-lg border border-amber-100">
                      ...
                      <div className="text-sm text-amber-700">
                        ...
                        Microsoft Authenticator, or Authy to scan the QR code.
                      </div>
                    </div>
                  )}
                </div>
              ...
              <div className="settings-card">
                ...
                <div className="settings-card-content space-y-3">
                  {activeSessions.map((session) => (
                    <div
                      key={session.id}
                      className="session-item flex items-center justify-between"
                    >
                      <div className="flex-1">
                ...
                <div className="settings-card-content">
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-700">
                        Review active sessions regularly and logout unused
                        devices
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-700">
                        Never share your password or authenticator codes with
                        anyone
                      </span>
                    </li>
                  </ul>
